...
Pro users can attach interval protocols to custom workouts (density, tabata, superset time-blocks) and run gym-loud auto-advancing timers while logging weight/reps.

Third-party branded workout packs are **not** shipped. Users build or import their own custom templates.
...
- [x] Third-party Gravity Transformations pack **removed** (IP)
