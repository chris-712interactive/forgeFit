...
- [x] `PATCH /api/nutrition/logs/[id]` — edit entry macros, name, meal slot, servings, line-item quantities (2026-06-28; qty adjust 2026-07-19)
...
- [x] **Meal log quantity** — whole-number servings to log (1→2→3), per-ingredient qty on log/edit, Log again opens adjust sheet (2026-07-19)
