...
- **Custom workouts** (Pro) — build your own sessions from the equipment-aware exercise library; save templates; import/export native ForgeRep CSV; clear a program week and fill it with customs
