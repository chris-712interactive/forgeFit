  ...
  return (
    <MarketingSection>
      <MarketingSectionIntro
        ...
        description="Core training, nutrition, and progress tools are included at no cost. Upgrade to Pro for long-horizon analytics, or Pro+ for device sync, restaurant search, and AI coaching."
      />
