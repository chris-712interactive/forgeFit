...
export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "No. Program logic is deterministic and sourced from the evidence knowledge base. Motivational coaching copy on Pro+ is personalized from your goal and progress — never used for workout structure or exercise selection.",
  },
  {
    question: "What goals does ForgeRep support?",
    answer:
      "Fat loss, muscle gain, strength, body recomposition, general fitness, sport performance, and functional conditioning. Plans adapt to your experience level, available equipment, and how many days per week you can train.",
  },
  {
    question: "What's included in Pro vs Pro+?",
    answer:
      "Pro adds 90-day projections with confidence bands, custom workouts, strength and volume analytics, adaptive TDEE, unlimited history, progress photos, and community features like leaderboards and rivals. Pro+ includes everything in Pro plus Fitbit/Google Health sync, restaurant quick-log, saved meals, personalized coaching copy, and PR celebration UX. More wearables (Withings, Strava) roll out as they pass production QA.",
  },
  {
    question: "Can I track macros and calories with ForgeRep?",
    answer:
      "Yes. Your daily protein, carb, and fat targets come from your personalized plan. Log whole foods from the curated library (plus barcode lookup for packaged items) and see progress bars on your home dashboard — the same screen that shows this week's workouts.",
  },
  {
